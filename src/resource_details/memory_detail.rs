...
//         let header = container(row!["Memory"]).center_x().width(Length::Fill);
...
//                 column![
//                     row![
//                         text(icons::Bootstrap::Memory.to_string()).font(
//                             Font {
...
//                 column![
//                     row![
//                         text(icons::Bootstrap::HddRack.to_string()).font(
//                             Font {
//                                 family: font::Family::Name("bootstrap-icons"),
//                                 ..Default::default()
//                             }
...
//                 swap_details,
//                 row![
//                     text(icons::Bootstrap::Tools.to_string()).font(
//                         Font {
//                             family: font::Family::Name("bootstrap-icons"),
//                             ..Default::default()
//                         }
...
//                 .spacing(10),
//                 row![
//                     text(icons::Bootstrap::InfoCircle.to_string()).font(
//                         Font {
//                             family: font::Family::Name("bootstrap-icons"),
//                             ..Default::default()
//                         }
